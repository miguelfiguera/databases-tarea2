...
DROP TABLE IF EXISTS Applied_Treatments;
...
CREATE TABLE Office_Assignments (
    id INT AUTO_INCREMENT PRIMARY KEY,
    doctor_id INT NOT NULL,
    office_identifier VARCHAR(20) NOT NULL,
...
CREATE TABLE Applied_Treatments (
    ...
    CONSTRAINT fk_applied_treatment_prescribing_doctor
        ...
        REFERENCES Doctors(id)
        ON DELETE SET NULL,
    CONSTRAINT chk_record_or_appointment CHECK (medical_record_id IS NOT NULL OR appointment_id IS NOT NULL)
);
